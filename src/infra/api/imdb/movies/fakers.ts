import { ComingSoonMovies, MostPopularMovies, TheBestMovies, DetailMovie } from '../../../../domain/models'

export const makeFakeListTheBestResponse = (): TheBestMovies[] => (
  [{
    id: 'valid_id',
    crew: 'valid_crew',
    title: 'valid_title',
...
export const makeFakeListMostPopularResponse = (): MostPopularMovies[] => (
  [{
    id: 'valid_id',
    crew: 'valid_crew',
    title: 'valid_title',
...
export const makeFakeListComingSoonResponse = (): ComingSoonMovies[] => (
  [{
    id: 'valid_id',
    title: 'valid_title',
    year: 2021,
...
export const makeFakeListDetailResponse = (): DetailMovie => ({
  id: 'valid_id',
  fullTitle: 'valid_full_title',
  title: 'valid_title',
  year: 2021,
